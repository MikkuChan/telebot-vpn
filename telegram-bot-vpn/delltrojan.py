...
# -*- coding: utf-8 -*-
"""
Script untuk menghapus akun TROJAN
...
def count_trojan_clients():
    """Menghitung jumlah client Trojan dari config.json"""
    try:
        with open('/etc/xray/config.json', 'r') as f:
            content = f.read()
        
        # Mencari pattern #! untuk menghitung client
        pattern = r'^#! '
...
def get_user_info(username):
    ...
    try:
        ...
        # Mencari UUID/password
        lines = content.split('\n')
        uuid = None
        
        for i, line in enumerate(lines):
            if f"#! {username} {exp_date}" in line:
                # Mencari password dalam beberapa baris setelahnya
                for j in range(i+1, min(i+10, len(lines))):
                    if '"password"' in lines[j]:
                        # Extract password dari line
                        password_match = re.search(r'"password"\s*:\s*"([^"]+)"', lines[j])
                        if password_match:
                            uuid = password_match.group(1)
                            break
                break
...
def remove_user_from_db(username, exp_date):
    """Menghapus user dari database trojan"""
    try:
...
def remove_user_files(username):
    ...
    try:
        ...
        user_folder = f'/etc/trojan/{username}'
        if os.path.exists(user_folder):
            shutil.rmtree(user_folder)
        
        # Menghapus file limit
        limit_file = f'/etc/kyt/limit/trojan/ip/{username}'
...
def send_telegram_notification(username, uuid, exp_date, system_info):
    ...
    try:
        ...
        # Menyiapkan message
        message = f"""<b>━━━━━━━━━━━ DELETE TROJAN ACCOUNT ━━━━━━━━━━━</b>
...
def write_log(username, uuid, exp_date):
    ...
    try:
        ...
        log_content = f"""━━━━━━━━━━━ DELETE TROJAN ACCOUNT ━━━━━━━━━━━
┣ Timestamp  : {timestamp}
┣ Username   : {username}
┣ UUID       : {uuid}
┣ Expired On : {exp_date}
...
def main():
    ...
    client_count = count_trojan_clients()
    if client_count == 0:
        clear_screen()
        print(f"{Colors.NC}━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━\033[0m")
        print(f"{Colors.BGWHITE}         Hapus Akun Trojan         {Colors.NC}")
        print(f"{Colors.NC}━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━\033[0m")
        print("")
        print("Anda Tidak Memiliki Member Trojan")
        print("")
        print(f"{Colors.NC}━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━\033[0m")
        sys.exit(1)
    ...
    if success:
        ...
        clear_screen()
        print(f"{Colors.NC}━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━\033[0m")
        print("» Akun Trojan Berhasil Dihapus!")
        print(f"{Colors.NC}━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━\033[0m")
