...
# -*- coding: utf-8 -*-
"""
cekuser-vless: Daftar user VLESS (username, uuid, expired) + kirim ke Telegram
...
class VlessUserChecker:
    ...
    def _extract_users(self, config_content):
        """Ekstrak daftar user VLESS dari konfigurasi Xray"""
        users = []
        lines = config_content.split('\n')
        
        for line in lines:
            # Cari baris yang dimulai dengan "#& " (komentar user VLESS)
    ...
    def _find_uuid_for_user(self, config_content, username):
        """Mencari UUID untuk user VLESS tertentu"""
        try:
            # Parse sebagai JSON untuk mendapatkan struktur yang tepat
            config_json = json.loads(config_content)
            
            # Cari dalam inbounds untuk konfigurasi VLESS
    ...
    def _format_terminal_output(self, users_data):
        ...
        if not users_data:
            print("📋 Tidak ada user VLESS yang ditemukan.")
            return
        
        # Header
        header = "━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━"
        title = "DAFTAR USER VLESS"
    ...
    def _create_telegram_message(self, users_data):
        ...
        if not users_data:
            return "<b>📋 DAFTAR USER VLESS</b>\n\n❌ Tidak ada user yang ditemukan."
        
        # Header pesan
        header = "<b>🔍 DAFTAR USER VLESS</b>"
        separator = "━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━"
    ...
    def run(self):
        ...
        print("🚀 Memulai pengecekan user VLESS...")
        ...
        # Ekstrak daftar user
        print("🔍 Mengekstrak daftar user VLESS...")
        users = self._extract_users(config_content)
        
        if not users:
            print("❌ Tidak ada user VLESS yang ditemukan dalam konfigurasi.")
            return
